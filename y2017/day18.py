...
if __name__ == '__main__':
    data_example = data_import('y2017/data/day18_example', str, ' ')
    print('Solution of 1 is', part1(data_example))
    data_example2 = data_import('y2017/data/day18_example2', str, ' ')
    print('Solution of 2 is', part2(data_example2))

    data_real = data_import('y2017/data/day18_real', str, ' ')
